========================================================================
    KONSOLENANWENDUNG: Game_Code-Projektübersicht
========================================================================

Diese Game_Code-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Game_Code-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Game_Code.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
